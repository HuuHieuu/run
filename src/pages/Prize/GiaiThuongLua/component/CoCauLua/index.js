...
import styles from './CoCauLua.module.scss';
    ...
    return ( 
        ...
        <div style={{display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center'}}>
            ...
            <table style={{maxWidth:'1271px'}} className={cx('table')}>
                ...
                <tbody>
                    ...
                    <tr className={cx('tr-size')}>
                        ...
                        <td rowSpan={2}>
                            <div>
                                <b>CHIẾN BINH KẾT NỐI - NHIỆT HUYẾT</b>
                            </div>
                            Giải thưởng dành riêng cho Thử thách Lửa
                        </td>
                        <td rowSpan={2}>
                            <ul>
                                <li>Chiến binh có số lượng người được mời tham gia (và đồng thời có hoạt động trên Cung Đường Yêu Thương) nhiều nhất toàn thử thách Lửa.</li>
                                <li>Tối thiểu 20 người được mời có hoạt động trong thử thách Lửa.</li>
                                <li>Tiêu chí phụ: Tổng quãng đường (tự động + thủ công) của người được mời lớn nhất</li>
                                <li>Nếu số lượng người được mời tham gia không xác thực &gt;20 người, toàn bộ kết quả giải thưởng Chiến binh Kết nối - Nhiệt huyết của cá nhân sẽ không được công nhận.</li>
                            </ul>
                        </td>
                        <td rowSpan={2}>Bộ quà tặng: áo hoodie, đai đeo chạy bộ, găng tay chạy bộ</td>
                        <td rowSpan={2} className={cx('td-center')}></td>
                        <td rowSpan={2} className={cx('td-center')}>3</td>
                        <td rowSpan={2} className={cx('td-center')}>2</td>
                        <td rowSpan={2} className={cx('td-center')}>5</td>
            ...
            * Giải rút thăm may mắn sẽ được tổ chức thông qua hình thức rút thăm dựa trên mã số đăng ký (số BIB) của người tham gia và được phát sóng trực tiếp (livestream) trên trang Facebook của chương trình tại: https://www.facebook.com/DLVNCungDuongYeuThuong trong vòng 5-7 ngày làm việc sau khi Thử thách kết thúc.
            <ul>
                <li>+ Bảng cơ cấu giải thưởng này chỉ dành riêng cho Thử thách Lửa.</li>
