...
import styles from './CoCauVo.module.scss';
...
function CoCauVo() {
    return ( 
        ...
        <div style={{display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center'}}>
                    ...
                    <tr className={cx('tr-size')}>
                        ...
                        <td rowSpan={2}>
                            <ul>
                                ...
                                <li>Kết quả được tính dựa trên tổng quãng đường ghi nhận xét thành tích xếp hạng (có giới hạn 30km/ ngày)</li>
                                <li>Chỉ dành cho những thành viên chưa đạt giải ở các Thử thách trước</li>
                            </ul>
                        </td>
                        <td rowSpan={2}>Áo thun</td>
                        <td rowSpan={2} className={cx('td-center')}></td>
                        <td rowSpan={2} className={cx('td-center')}>300</td>
            ...
            <div style={{marginTop:'50px'}}><h1>G. QUÀ TẶNG ĐẶC BIỆT TỪ ĐỐI TÁC</h1></div>
            <table style={{maxWidth:'1271px'}} className={cx('table')}>
                <thead>
                    <tr className={cx('tr-size')} style={{backgroundColor: '#C68158', color: 'white'}}>
                        <th rowSpan={2}>STT</th>
                ...
                <tr className={cx('tr-size')}>
                        ...
                        <td rowSpan={2}>
                            <ul>
                                <li>Thành viên mới đăng ký tham gia Dai-ichi Life - Cung Đường Yêu Thương trong Thử thách Vô.</li>
                                <li>Hoàn thành 30km từ các hoạt động ghi nhận từ động, có quãng đường/quãng đường quy đổi tối thiểu 1km.</li>
                                <li>Danh sách đạt giải được tính theo thời gian hoàn thành 30km.</li>
                            </ul>
                        </td>
                        <td rowSpan={2}>Voucher luyện tập 2 tháng miễn phí tại Citigym</td>
                        <td rowSpan={2} className={cx('td-center')}>150</td>
                        <td rowSpan={2} className={cx('td-center')}></td>
                        <td rowSpan={2} className={cx('td-center')}></td>
                        <td rowSpan={2} className={cx('td-center')}></td>
                    ...
                    <tr className={cx('tr-size')}>
                        ...
                        <td rowSpan={2}>
                            <div>
                                <b>CHIẾN BINH THỬ THÁCH VÔ</b>
                            </div>
                            Giải thưởng chỉ dành cho các thành viên sinh sống và làm việc tại TP. Hồ Chí Minh
                        </td>
                        <td rowSpan={2}>
                            <ul>
                                <li>Thành viên có tổng quãng đường lớn nhất.</li>
                                <li>Hoạt động được tính là hoạt động ghi nhận từ động có quãng đường/quãng đường quy đổi tối thiểu 1km.</li>
                                <li>Danh sách đạt giải được tính theo thời gian hoàn thành 30km.</li>
                            </ul>
                        </td>
                        <td rowSpan={2}>Voucher luyện tập 2 tháng miễn phí tại Citigym</td>
            ...
            * Giải rút thăm may mắn sẽ được tổ chức thông qua hình thức rút thăm dựa trên mã số đăng ký (số BIB) của người tham gia và được phát sóng trực tiếp (livestream) trên trang Facebook của chương trình tại: https://www.facebook.com/DLVNCungDuongYeuThuong trong vòng 5-7 ngày làm việc sau khi Thử thách kết thúc.
            <ul>
                <li>+ Bảng cơ cấu giải thưởng này chỉ dành riêng cho Thử thách Vô.</li>
