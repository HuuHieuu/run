...
import styles from './CoCauDat.module.scss';
    ...
    return ( 
        ...
        <div style={{display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center'}}>
                ...
                <tbody>
                    ...
                    <tr className={cx('tr-size')}>
                        ...
                        <td rowSpan={2}>
                            ...
                            Thành viên mới tham gia hoàn thành 100km đầu tiên
                        </td>
                        <td rowSpan={2}>
                            <ul>
                                <li>Thành viên mới tham gia hoàn thành 100km sớm nhất của Thử thách (đi/chạy bộ có GPS)</li>
                                <li>Danh sách đạt giải không bao gồm thành viên đã đạt giải Chiến binh Năng nổ</li>
                            </ul>
                        </td>
                        <td rowSpan={2}>Áo thun</td>
                        <td rowSpan={2} className={cx('td-center')}></td>
                    ...
                    <tr className={cx('tr-size')}>
                        ...
                        <td rowSpan={2}>
                            <ul>
                                ...
                                <li>Danh sách đạt giải không bao gồm top 5 nam/nữ chiến binh xuất sắc nhất</li>
                            </ul>
                        </td>
                    ...
                    <tr className={cx('tr-size')}>
                        ...
                        <td rowSpan={2}>
                            <ul>
                                <li>Thành viên có tổng quãng đường đi/chạy bộ (có GPS) trong 1 tuần tăng 10% so với thành tích tuần trước đó của Thử thách</li>
                                <li>Thời gian tính kết quả của tuần tính từ 00:00 thứ Hai và kết thúc vào lúc 24:00 Chủ Nhật</li>
                                <li>Giải thưởng Chiến binh Tiến bộ của Thử thách Đất được tính dựa trên kết quả được ghi nhận từ ngày 17/04/2023</li>
                                <li>Tiêu chí phụ: Tổng quãng đường dài nhất</li>
                            </ul>
                        </td>
                        <td rowSpan={2}>Áo thun</td>
                        <td rowSpan={2} className={cx('td-center')}>200</td>
                    ...
                    <tr className={cx('tr-size')}>
                        ...
                        <td rowSpan={2}>
                            <div>
                                <b>CÂU LẠC BỘ CHIẾN BINH CÓ NHIỀU TÂN BINH NHẤT</b>
                            </div>
                            Câu lạc bộ có nhiều Tân binh nhất của Thử thách
                        </td>
                        <td rowSpan={2}>
                            <ul>
                                <li>Số lượng thành viên mới tham gia của Câu lạc bộ trong Thử thách (từ khi bắt đầu đến lúc kết thúc Thử thách)</li>
                                <li>Thành viên mới tham gia phải có ít nhất 1 hoạt động được ghi nhận tự động trong mỗi Thử thách</li>
                                <li>Thông tin của thành viên mới (số điện thoại, email) và hoạt động phải được chứng thực</li>
                            </ul>
                        </td>
                        <td rowSpan={2}>100 Phiếu mua hàng điện tử trị giá 50,000 đồng</td>
                        <td rowSpan={2} className={cx('td-center')}></td>
                        <td rowSpan={2} className={cx('td-center')}>1</td>
                        <td rowSpan={2} className={cx('td-center')}>1</td>
                        <td rowSpan={2} className={cx('td-center')}>2</td>
                    ...
                    <tr className={cx('tr-size')}>
                        ...
                        <td rowSpan={2}>Giày Asics Nova Blast</td>
                        <td rowSpan={2} className={cx('td-center')}>1</td>
                        <td rowSpan={2} className={cx('td-center')}></td>
                        <td rowSpan={2} className={cx('td-center')}></td>
                        <td rowSpan={2} className={cx('td-center')}></td>
                    ...
                    <tr className={cx('tr-size')}>
                        ...
                        <td rowSpan={2}>Giày Asics GT1000-11</td>
                        <td rowSpan={2} className={cx('td-center')}>1</td>
                        <td rowSpan={2} className={cx('td-center')}></td>
                        <td rowSpan={2} className={cx('td-center')}></td>
                        <td rowSpan={2} className={cx('td-center')}></td>
            ...
            * Giải rút thăm may mắn sẽ được tổ chức thông qua hình thức rút thăm dựa trên mã số đăng ký (số BIB) của người tham gia và được phát sóng trực tiếp (livestream) trên trang Facebook của chương trình tại: https://www.facebook.com/DLVNCungDuongYeuThuong trong vòng 5-7 ngày làm việc sau khi Thử thách kết thúc.
            <ul>
                <li>+ Bảng cơ cấu giải thưởng này chỉ dành riêng cho Thử thách Đất.</li>
